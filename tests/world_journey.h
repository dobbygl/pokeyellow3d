...
inline int world_journey(GBContext* ctx,bool viridian=false) {
    ...
    auto tick=[&]() {
        ...
        require(pallet3d_active()==(pallet3d_blend().active||state==pallet::View::Overworld||state==pallet::View::Battle||pallet3d_warp_overlay()||pallet3d_battle_transition().active||pallet3d_menu().active||
        ...
        previous_3d=pallet3d_active()&&state!=pallet::View::Battle&&!pallet3d_battle_transition().active;
    };
